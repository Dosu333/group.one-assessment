...
DATABASES = {
    "default": {
        ...
        "NAME": config("POSTGRES_DB", "license_db"),
        "USER": config("POSTGRES_USER", "license_user"),
        "PASSWORD": config("POSTGRES_PASSWORD", "license_pass"),
        "HOST": config("SQL_HOST", "localhost"),
        "PORT": config("SQL_PORT", 5432, cast=int),
    }
}
